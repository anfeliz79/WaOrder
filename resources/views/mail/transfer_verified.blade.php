...
<head>
    ...
    <title>Transferencia aprobada</title>
    <style>
...
<div class="wrapper">
    ...
    <div class="body">
        ...
        <h2>¡Tu transferencia fue verificada!</h2>
        <p>
            Hola, hemos confirmado tu pago por transferencia bancaria y tu suscripción a WaOrder
            ya está <strong>activa</strong>. Ya puedes completar la configuración de tu restaurante.
        </p>
        ...
        <div class="detail-box">
            ...
            <div class="detail-row">
                <span class="detail-label">Monto confirmado</span>
            ...
            <div class="detail-row">
                ...
                <span class="detail-value">{{ $verification->verified_at->format('d/m/Y H:i') }}</span>
            </div>
        </div>

        @if($verification->admin_notes)
        <p><strong>Nota del equipo:</strong> {{ $verification->admin_notes }}</p>
        @endif

        <a href="{{ config('app.url') }}/setup" class="btn">Ir a configurar mi restaurante →</a>
    </div>
    <div class="footer">
